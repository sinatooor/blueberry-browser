...
export type EndpointSpec = {
  ...
  // Short, human-readable label generated by the LLM from the endpoint
  // shape (e.g. "Monthly revenue", "Billing events"). Filled in lazily
  // after the first capture; falls back to pathname while pending.
  name?: string;
  queryKeys: string[];
  contentType?: string;
